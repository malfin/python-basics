...
class Dialog(models.Model):
    owner = models.ForeignKey(User, verbose_name='создатель', on_delete=models.CASCADE, related_name="selfDialogs")
    opponent = models.ForeignKey(User, verbose_name='получатель', on_delete=models.CASCADE)
...
class Message(models.Model):
    ...
    def __str__(self):
        return f'{self.dialog} - {self.sender}'
